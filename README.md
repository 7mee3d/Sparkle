# ✨ Sparkle — Smart Car & Carpet Cleaning Management System

> 🚗🧼 **Sparkle** is a modern C# Windows Forms application designed to manage customers, users, and cleaning orders for both **cars** and **carpets**, all stored and handled efficiently using **text files (.txt)**.
